...
C++ supports the usual logical conditions from mathematics. You can use these conditions to perform different actions for different decisions. C++ has the following con …
_________
_________
Booleans
https://www.w3schools.com/cpp/cpp_booleans.asp
Very often, in programming, you will need a data type that can only have one of two values, like: YES / NO ON / OFF TRUE / FALSE For this, C++ has a bool data type, wh …
_________
_________
Strings
...
As explained in the Variables chapter, a variable in C++ must be a specified data type. The data type specifies the size and type of information the variable will store.
_________
